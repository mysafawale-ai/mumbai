...
<p>Safawala Mumbai – <strong>Holi turban in Mumbai</strong> for colorful celebrations.</p>
    `,faqs:[{question:"Is turban for before color play?",answer:"Yes, Holi turban in Mumbai is typically worn before colors for photographs and puja."},{question:"What colors suit Holi?",answer:"Holi turban in Mumbai offers pink, yellow, green, and orange – festive colors."},{question:"Do you service Holi events?",answer:"Yes, Holi turban in Mumbai service is available for corporate and society events."},{question:"Is morning service available?",answer:"Yes, Holi turban in Mumbai timing is flexible for morning celebrations."},{question:"Can families get matching turbans?",answer:"Yes, Holi turban in Mumbai can coordinate colors for family members."},{question:"Is advance booking needed?",answer:"Yes, Holi turban in Mumbai should be booked ahead during festival season."}]};return(0,b.jsx)(c.ServicePageTemplate,{...a})}a.s(["default",()=>e,"metadata",0,{title:"Holi Turban in Mumbai | Festival Colors Safa | Safawala Mumbai",description:"Colorful Holi turban in Mumbai by Safawala Mumbai. Festival of colors celebration safa. Premium Holi turban in Mumbai for festive events. Book today!",keywords:"holi turban in mumbai, festival colors safa, holi pagdi mumbai, colorful turban service, holi celebration turban",openGraph:{title:"Holi Turban in Mumbai | Festival Colors Safa | Safawala Mumbai",description:"Colorful Holi turban in Mumbai by Safawala Mumbai.",url:"https://safawalamumbai.com/holi-turban-in-mumbai",type:"website"}}])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__1cc877fa._.js.map