...
export const metadata: Metadata = {
  title: "Purple Safa in Mumbai | Purple Turban Tying | Safawala Mumbai",
  description: "Royal purple safa in Mumbai by Safawala Mumbai. Regal purple turban for grand weddings. Premium purple safa in Mumbai for luxury celebrations. Book today!",
  keywords: "purple safa in mumbai, purple turban mumbai, violet safa mumbai, royal purple pagdi, purple wedding turban",
  openGraph: {
    title: "Purple Safa in Mumbai | Purple Turban Tying | Safawala Mumbai",
    description: "Royal purple safa in Mumbai by Safawala Mumbai.",
    url: "https://safawalamumbai.com/purple-safa-in-mumbai",
    type: "website",
  },
}

export default function PurpleSafaInMumbai() {
  const pageData = {
    title: "Purple Safa in Mumbai",
    shortDescription: "Purple is the color of royalty, luxury, and sophistication. Throughout history, purple dyes were rare and expensive, making purple attire the preserve of kings. Safawala Mumbai's purple safa in Mumbai brings this regal heritage to modern celebrations. Our purple safa in Mumbai offers a distinctive and striking appearance for grooms who want to stand out.",
